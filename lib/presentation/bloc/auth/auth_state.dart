...
class ChangePasswordAuthState extends AuthState {
  const ChangePasswordAuthState();
}

class DeleteAccountAuthState extends AuthState {
  const DeleteAccountAuthState();
}

class UpdateUserAuthState extends AuthState {
